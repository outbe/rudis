...
mod tests {
    ...
    fn restart_reannounces_durable_closure_without_advancing_and_detects_lost_consumer() {
        ...
        // macOS temporary directories may use the /var symlink; the store
        // deliberately accepts only paths with no symlink components.
    ...
    fn finalized_materialization_wake_uses_the_authenticated_system_tx_signer() {
        ...
        let signer = OutbeEvmSigner::from_secret_bytes(outbe_primitives::test_keys::secret(0x41))
            .expect("test signer");
